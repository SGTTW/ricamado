              ...
              <div className="flex items-center gap-4">
                ...
                <div className="relative" ref={shareRef}>
                  <button
                    ...
                    className="flex items-center px-3 py-2 bg-gray-50 hover:bg-gray-100 text-gray-700 rounded-lg transition-colors"
                  >
                  ...
                  {showShareOptions && (
                    <div className="absolute top-12 right-0 bg-white rounded-lg shadow-lg p-2 z-20 min-w-[150px]">
                      <button
