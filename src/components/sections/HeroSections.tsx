  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center">
      ...
      <motion.div
        ...
        style={{
          backgroundImage: "url(/images/background/bgImage.png)",
      ...
      <div className="relative z-10 container mx-auto px-6 text-white text-center">
        <motion.div variants={textVariants} initial="initial" animate="animate">
          ...
          <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto">
            ...
            environments that inspire growth, connection, and personal
            transformation.
          </p>
          ...
          <div className="mt-10 flex justify-center space-x-4">
            ...
            <Link
              href="/contact"
              className="px-8 py-3 border-2 border-white text-white rounded-full hover:bg-white/10 transition outline-none"
            >
              Contact
            </Link>
          </div>
